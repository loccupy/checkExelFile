...
from libs.get_path_to_exel_file import get_device_type, get_number_of_files_in_directory_exel_file, \
    get_path_to_exel_file, convert_folder, check_folder

index_of_the_first_meter_for_active_energy_table_for_1ph = 20
index_of_the_first_meter_for_reactive_energy_table_for_1ph = 47
...
def main_change():
    try:
        flag = check_folder()
        if flag == 1:
            print("В каталоге нет '.xlsx' или '.xls' файлов")
            return
        elif flag == 2:
        ...
        for number_of_file in range(number_of_files):
            ...
            if device_type == "1PH":
                for i in range(24):
                    ...
                    reactive_energy = ReactiveEnergy(index_of_the_first_meter_for_reactive_energy_table_for_1ph + i,
                                                     sheet)
                    ...
                    print(
                        f'...................   Проверка счетчика №{AllData1PH.serial_number.value} завершена   ................')
            else:
                if device_type == "TT":
                ...
                for i in range(16):
                    active_energy = ActiveEnergy(index_of_the_first_meter_for_active_energy_import_table_for_3ph + i,
                                                 sheet)
                    ...
                    active_energy = ActiveEnergy(index_of_the_first_meter_for_active_energy_export_table_for_3ph + i,
                                                 sheet)
                    ...
                    reactive_energy = ReactiveEnergy(
                        index_of_the_first_meter_for_reactive_energy_import_table_for_3ph + i, sheet)
                    ...
                    reactive_energy = ReactiveEnergy(
                        index_of_the_first_meter_for_reactive_energy_export_table_for_3ph + i, sheet)
